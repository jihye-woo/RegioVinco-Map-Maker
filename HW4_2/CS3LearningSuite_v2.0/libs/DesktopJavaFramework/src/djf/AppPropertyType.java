...
public enum AppPropertyType {
    ...
    // CREATE NEW MAP DIAGLOG
    LOAD_PARENTREGION_TITLE,
    LOAD_DATAFILE_TITLE,
    ...
    // Creat New Map Dialog
     ...
     MAP_DIMENSIONS_DIALOG_HEIGHT_LABEL_TEXT,
     ...
     CREATENEW_DIALOG_PARENTS_BUTTON_TEXT,
     
     // Map Maker Load Dialog
     LOAD_DIALOG_HEADER_LABEL, LOAD_DIALOG_REGIONAME_LABEL,
     LOAD_DIALOG_CHOOSER_BUTTON, LOAD_DIALOG_CHOOSER_LABEL,
     LOAD_DIALOG_OKBUTTON, LOAD_DIALOG_REGIONAME_LABEL_TEXT,
     LOAD_DIALOG_CHOOSER_BUTTON_TEXT,  LOAD_DIALOG_CHOOSER_LABEL_TEXT,
     LOAD_DIALOG_HEADER_LABEL_TEXT,
     
     // Map Maker Rename Dialog
     RENAME_DIALOG_HEADER_LABEL, RENAME_DIALOG_OLD_LABEL,
     RENAME_DIALOG_NEW_LABEL, RENAME_DIALOG_OKBUTTON, 
     RENAME_DIALOG_HEADER_LABEL_TEXT,
     RENAME_DIALOG_OLD_LABEL_TEXT,
     RENAME_DIALOG_NEW_LABEL_TEXT
